 ...
 *
 *This is a class definition for the shopping cart
 */
public class ShoppingCartBadia {
	...
	///**
	 //* The method calculates the total quantity of items in the list
	 //* @return the total quantity of items in the list
	 //*/
	//public int calcTotalQuant() {
		//int totalQuant = 0;
		//for (int i = 0; i < getSize(); i++) {
			//totalQuant += myItems[i].getQuant();
		//}//for
		//return totalQuant;
	//}//calcTotalQuant
