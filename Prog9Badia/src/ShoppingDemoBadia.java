...
*@author AlexBadia <br>
*Prog 9 <br>
*Due Date and Time: 04/11/19 before 1:30 PM <br>
*
*Purpose: to refine our knowledge about ordered array implementation. <br>
*
...
public class ShoppingDemoBadia {
	...
	public static void main (String args[]) {
		...
		boolean invalid = false, retry = true, enterFile = false;
		
		System.out.println("Welcome to the shopping menu, would you like to enter a file (Type: Yes [to enter a file] or No [to continue to the menu]): ");
		...
		while (choice != '0') {
			...
			switch (choice) {				
				case '1':
					...
					else System.out.println("Item could not be added to the cart!\n");
					choice = '?';
					break;
				...
				case '2':
					...
					if (shoppingCart.remove (itemToDelete))
						System.out.println("The item, " + itemToDelete + ", was succesfully removed from the shopping cart.\n");
					else System.out.println("The item, " + itemToDelete + ", you want to remove from the cart does not exist in the cart.\n");
					choice = '?';
					break;
				...
				case '4':
					...
					if (shoppingCart.retrieve(target) == null) {
						System.out.println("The item, " + target + ", you're looking for isn't in your cart!\n");
					} else System.out.println(shoppingCart.retrieve(target).toString());
					choice = '?';
					break;
